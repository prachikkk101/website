...
import {
  getAdminDashboard,
  getUsers, createUser, updateUser, deleteUser, removeSiteAssignment, removeSingleSiteAssignment,
...
router.delete('/users/:userId/site-assignment/:siteId',  ...adminOnly, removeSingleSiteAssignment);
