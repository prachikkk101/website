...
export default function Register() {
  ...
  async function handleRegister(e) {
    ...
    try {
      // registerUser: no OTP step for supervisors/workers — backend sets emailVerified=true immediately
          ...
          <form onSubmit={handleRegister}>
            ...
            <button type="submit" disabled={loading || !!success}
              style={{
                ...
                borderRadius: 8, fontSize: 15, fontWeight: 700, cursor: (loading || !!success) ? 'not-allowed' : 'pointer',
